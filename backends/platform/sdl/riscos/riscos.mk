...
riscosdist: all
	mkdir -p $(APP_NAME)
	elf2aif $(EXECUTABLE) $(APP_NAME)/novelvm,ff8
	...
	sed -i -e "s/|WimpSlot/WimpSlot -min `du -k $(APP_NAME)/novelvm,ff8 | cut -f1`K/g" $(APP_NAME)/!Run,feb
...
riscosdist: $(APP_NAME)/docs/NovelVM,3d6
...
define manual-markdown
	...
	echo "NovelVM - $(notdir $(basename $1)) " > $(APP_NAME)/tmp/$2,fff
